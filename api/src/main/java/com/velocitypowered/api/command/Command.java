...
public interface Command {
     ...
     */
    void execute(@NonNull CommandSource source, @NonNull String @NonNull [] args);
     ...
     */
    default List<String> suggest(@NonNull CommandSource source, @NonNull String @NonNull [] currentArgs) {
     ...
     */
    default boolean hasPermission(@NonNull CommandSource source, @NonNull String @NonNull [] args) {
        return true;
    }
}
