 ...
 * <br>- If the player has <u>not</u> notified the server within 60 ticks after joining the server - ({@link #timeout} = true)
 */
@Beta
public final class PlayerClientLoadedWorldEvent {
   ...
   * for 60 ticks after the player joined the server.
   *
