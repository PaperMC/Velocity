...
package com.velocitypowered.proxy.network.protocol.packet.chat.keyed;
...
public class KeyedPlayerCommand implements MinecraftPacket {
  ...
  private long salt;
  private boolean signedPreview; // purely for pass through for 1.19 -> 1.19.2
  ...
  public void decode(ByteBuf buf, Direction direction,
    ...
    if (protocolVersion.compareTo(ProtocolVersion.MINECRAFT_1_19_1) >= 0) {
      ...
      if (size < 0 || size > KeyedPlayerChat.MAXIMUM_PREVIOUS_MESSAGE_COUNT) {
