...
package com.velocitypowered.proxy.network.util;
...
/**
 * An implementation of {@code InetNameResolver} that performs blocking DNS name lookups in a
 * separate thread, avoiding blocking the Netty threads for an extended period of time and without
 * the downsides of Netty's native DNS resolver.
 */
