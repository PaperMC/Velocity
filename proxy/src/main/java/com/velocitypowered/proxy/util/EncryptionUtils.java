...
public enum EncryptionUtils {
  ...
  /**
   * Generates 16 random bytes that may be used as shared secret.
   *
   ...
   *
   * @param key the key public key to use
   * @param bytes the bytes of the message to be encrypted
   * @return the encrypted message
   * @throws GeneralSecurityException if the message couldn't be encoded
   */
  ...
  /**
   * Decodes a public key encoded in X.509 format.
   *
   * @param bytes the bytes of public key in X.509 format
   * @return the decoded PublicKey
   * @throws GeneralSecurityException if key couldn't be decoded
   */
