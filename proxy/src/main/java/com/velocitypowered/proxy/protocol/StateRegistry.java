  ...
  PLAY {
    {
      ...
      serverbound.register(SessionPlayerChatPacket.class, SessionPlayerChatPacket::new,
      ...
      clientbound.register(DisconnectPacket.class, () -> new DisconnectPacket(false),
      ...
      clientbound.register(LegacyPlayerListItemPacket.class, LegacyPlayerListItemPacket::new,
      ...
      clientbound.register(UpsertPlayerInfoPacket.class, UpsertPlayerInfoPacket::new,
      ...
      clientbound.register(PlayerChatCompletionPacket.class, PlayerChatCompletionPacket::new,
          map(0x15, MINECRAFT_1_19_1, true),
          map(0x14, MINECRAFT_1_19_3, true),
          map(0x16, MINECRAFT_1_19_4, true),
          map(0x17, MINECRAFT_1_20_2, true));
      clientbound.register(ServerDataPacket.class, ServerDataPacket::new,
  ...
  LOGIN {
    {
      ...
      clientbound.register(LoginPluginMessagePacket.class,
