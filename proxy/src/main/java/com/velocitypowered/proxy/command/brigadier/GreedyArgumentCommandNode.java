...
/**
 * A greedy argument node that uses the given (possibly custom) {@link ArgumentType}
 * for parsing, while maintaining compatibility with the vanilla client.
 *
 * @param <S> the type of the command source
 * @param <T> the type of the argument to parse
 */
public final class GreedyArgumentCommandNode<S, T> extends ArgumentCommandNode<S, String> {

  private final ArgumentType<T> type;

  GreedyArgumentCommandNode(
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof GreedyArgumentCommandNode)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
    ...
    final GreedyArgumentCommandNode<?, ?> that = (GreedyArgumentCommandNode<?, ?>) o;
