...
/**
 * Base class for {@link CommandRegistrar}s capable of registering a subinterface
 * of {@link InvocableCommand} in the root node of a {@link CommandDispatcher}.
 *
...
abstract class InvocableCommandRegistrar<T extends InvocableCommand<I>,
  ...
  protected InvocableCommandRegistrar(final CommandDispatcher<CommandSource> dispatcher,
  ...
  private LiteralCommandNode<CommandSource> createLiteral(final T command, final CommandMeta meta,
    ...
    final ArgumentCommandNode<CommandSource, String> arguments = GreedyArgumentBuilder
            .<CommandSource, A>greedyArgument(VelocityCommands.ARGS_NODE_NAME, argumentsType)
